...
namespace CIELO_TM.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        {
            var userinSession = UserManager.FindById(User.Identity.GetUserId());


            BaseDatos db = new BaseDatos();
            var sql = from orden in db.ORDEN
                      join detalles in db.DETALLES_ORDEN on orden.OrderId equals detalles.OrderId where orden.cliente_id.Equals(userinSession.Id)
                      select new OrdenesViewModel()
                      {
                          cliente_id=orden.cliente_id,
                          OrderId=orden.OrderId,
                          OrderDate=orden.OrderDate,
                          OrderDetailId=detalles.OrderDetailId,
